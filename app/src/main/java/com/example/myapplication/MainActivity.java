...
public class MainActivity extends AppCompatActivity
    ...
    Dialog dialog;
    String Title, date_time, date, Userid;
    ...
    private void init(ArrayList<Promo> heros) {
        ...
        mPager = findViewById(R.id.pager);
        mPager.setAdapter(new SlidingImage_Adapter(MainActivity.this, heros));
...
//Set circle indicator radius
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            new AlertDialog.Builder(MainActivity.this)
                    .setTitle(getString(R.string.parcel_oman))
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            if (SaveSharedPreference.getLoggedStatus(getApplicationContext())) {
                ...
                if(getIntent().hasExtra("openHistory"))
                {
                    intent.putExtra("openHistory","yes");
                }
                startActivity(intent);
            }else{
            ...
            Intent contactus = new Intent(getApplicationContext(), LoginActivity.class);
            startActivity(contactus);
            ...
            public void onResponse(Call<PackageModel> call, Response<PackageModel> response) {
                if (response.isSuccessful()) {
                   ...
                   // GridLayoutManager latest = new GridLayoutManager(getApplicationContext(), 2);
                    LinearLayoutManager latest = new LinearLayoutManager(MainActivity.this);
                    ...
                    foodmenu.setAdapter(new Packages(packages, R.layout.menuslayouts, MainActivity.this));
    ...
    public void setLocale(String localeName) {
        if (!localeName.equals(currentLanguage)) {
            ...
            Toast.makeText(MainActivity.this, getString(R.string.language_already_selected), Toast.LENGTH_SHORT).show();
        }
    }
