...
public class MyAccountHome extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, WheelPicker.OnItemSelectedListener, DialogSubcAdapter.DialogInterface,ShowCardAdapter.InterfaceCard {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // moths=(LinearLayout)findViewById(R.id.months);
        //menus=(LinearLayout)findViewById(R.id.menus);
        // menuview=(LinearLayout)findViewById(R.id.menuview);
        //  foodmenu=(RecyclerView)findViewById(R.id.foodmenu);
        ...
        packagefreeze.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FreezePackageNew();
//                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(MyAccountHome.this);
//                String subscribeNow = preferences.getString(Constants.SUBSCRIBENOW, "no");
//                if (subscribeNow.equalsIgnoreCase("yes")) {
//                    Toast.makeText(MyAccountHome.this, getString(R.string.you_don_t_have_any_subscription_yet), Toast.LENGTH_SHORT).show();
//
//                } else {
//                    if (canFreeze.equalsIgnoreCase("yes")) {
//                        Toast.makeText(MyAccountHome.this, getString(R.string.you_have_exceeded), Toast.LENGTH_SHORT).show();
//
//
//                    } else {
//                        FreezePackage();
...
//                }
            ...
            public void onClick(View v) {
                ...
                if (subscribeNow.equalsIgnoreCase("yes")) {
                    ...
                    if (upgradeIt.equalsIgnoreCase("yes")) {
                        ...
                        Toast.makeText(MyAccountHome.this, getString(R.string.you_already_upgraded), Toast.LENGTH_SHORT).show();
                    }
                }
        ...
        deliveryAddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (subscribeNow.equalsIgnoreCase("yes")) {
                    ...
                    Intent intent = new Intent(MyAccountHome.this, SelectAddressActivity.class);
        ...
        target.setTitle(getString(R.string.logout_string));
        if (getIntent().hasExtra("openHistory")) {
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            new AlertDialog.Builder(MyAccountHome.this)
                    .setTitle("Food Parcel")
                    .setMessage("Do you really want to exit?")
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.finishAffinity(MyAccountHome.this);
                            finish();
                        }
                    })
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            SharedPreferences.Editor editor = preferences.edit();
            editor.clear();
            editor.putString(Constants.SETLANG, languageValue);
            editor.apply();
            ...
            Intent party = new Intent(getApplicationContext(), ParcelBoxActivity.class);
            party.putExtra("userId", Userid);
            startActivity(party);
    ...
    public void UpgradePackage() {
        ...
        dialog = new Dialog(MyAccountHome.this);
        ...
        try {
            ...
            packageWP.setOnItemSelectedListener(MyAccountHome.this);
        } catch (Exception ae) {
            ae.printStackTrace();
        }
    ...
    private void setCardDetails() {
        ...
        userService.showCards(task).enqueue(new Callback<List<GetCardModel>>() {
            ...
            public void onFailure(Call<List<GetCardModel>> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(MyAccountHome.this, "Failure Response", Toast.LENGTH_LONG).show();
            }
        });
    ...
    void sendCyberPay(String priceDetail, final String upgradeID, GetCardModel model) {
        ...
        final ProgressDialog dialog = new ProgressDialog(MyAccountHome.this);
        dialog.setCancelable(false);
        dialog.setMessage(getString(R.string.data_loading));
        dialog.show();
            ...
            public void onResponse(Call<CyberResponse> call, Response<CyberResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getReasonCode().equalsIgnoreCase("100")) {
                        ...
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Declined - The request is missing one or more fields", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("102")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Declined - One or more fields in the request contains invalid data.", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("150")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Error - General CyberSource system failure.", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("151")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Error - The request was received but there was a server timeout. This error does not include timeouts between the client and the server.", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("152")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Error: The request was received, but a service did not finish running in time.", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("204")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Decline - Insufficient funds in the account.", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("207")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Decline - Issuing bank unavailable.'", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("208")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Decline - Inactive card or card not authorized for card-not-present transactions.", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("209")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Decline - card verification number (CVV) did not match.", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("210")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Decline - The card has reached the credit limit.", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("211")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Decline - Invalid Card Verification Number (CVV).", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("221")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Decline - The customer matched an entry on the processor negative file.", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("222")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Decline - customer account is frozen", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("231")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Decline - Invalid account number", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("232")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Decline - The card type is not accepted by the payment processor.", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("240")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Decline - The card type sent is invalid or does not correlate with the credit card number.", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("250")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Error - The request was received, but there was a timeout at the payment processor.", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("480")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "The order is marked for review by Decision Manager", Toast.LENGTH_SHORT).show();
                    } else if (responseCode.equalsIgnoreCase("481")) {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "The order has been rejected by Decision Manager", Toast.LENGTH_SHORT).show();
                    } else {
                        hitGatewayCancel();
                        makeText(MyAccountHome.this, "Payment has been cancelled", Toast.LENGTH_SHORT).show();
                    }
...
*/
    ...
    public void FreezePackageNew() {
        Intent Home = new Intent(getApplicationContext(), MyFreezeDialog.class);
        startActivity(Home);
    }
    ...
    private void sendFreezeData(String subscriptionId, String userId, String startDate, String endDate) {
        ...
        userService.FreezePackage(task).enqueue(new Callback<ParcelDataModel>() {
            ...
            public void onResponse(Call<ParcelDataModel> call, Response<ParcelDataModel> response) {
                if (response.isSuccessful()) {
                    dialog.dismiss();
                    Toast.makeText(MyAccountHome.this, getString(R.string.package_freeze), Toast.LENGTH_SHORT).show();
                    ParcelCafe();
                    // recyclerView.setNestedScrollingEnabled(false);
                    //  parcelmenu.setAdapter(new PartyBoxAdapter(parcel, R.layout.addcart, PartyBox.this));
    ...
    private void showDatePickerDialog(final TextView spine) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(MyAccountHome.this, onDateSetListener, year, month, day);
    ...
    private void showEndDatePickerDialog(final TextView spin) {
        ...
        if (!startDateMin.isEmpty()) {
            ...
            datePickerDialog = new DatePickerDialog(MyAccountHome.this, onDateSetListener, year, month, day);
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this,
                new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        date = date_time;
                        Intent intent = new Intent(MyAccountHome.this, CheckoutPage.class);
                        startActivity(intent);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (cal_month.get(GregorianCalendar.MONTH) == 4 && cal_month.get(GregorianCalendar.YEAR) == 2017) {
                    ...
                    Toast.makeText(MyAccountHome.this, "Event Detail is available for current session only.", Toast.LENGTH_SHORT).show();
                } else {
                    setPreviousMonth();
                    refreshCalendar();
                }
...
/*
                 ...
                 */
                    ...
                    cal_month = (GregorianCalendar) GregorianCalendar.getInstance();
                    cal_month_copy = (GregorianCalendar) cal_month.clone();
                    hwAdapter = new HwAdapterSubcription(MyAccountHome.this, cal_month, HomeCollection.date_collection_arr, response.body().getSubscription(), restDays);
...
*//*
    ...
    private void showSubscriberDialog() {
        ...
        forgotBT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Intent intent = new Intent(MyAccountHome.this, ActivityMainHome.class);
                startActivity(intent);
            }
        });
        dialog.show();
    ...
    public void setLocale(String localeName) {
        if (!localeName.equals(currentLanguage)) {
            ...
            Toast.makeText(MyAccountHome.this, "Language already selected!", Toast.LENGTH_SHORT).show();
        }
    }
            ...
            public void onResponse(Call<paypalmodel> call, Response<paypalmodel> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getStatus().equals("200")) {
                        Toast.makeText(MyAccountHome.this, "Package Upgraded Successfully!", Toast.LENGTH_SHORT).show();
                    }
        ...
        userService.GetPaypalSuccess(task).enqueue(new Callback<paypalmodel>() {
            ...
            public void onResponse(Call<paypalmodel> call, Response<paypalmodel> response) {
                if (response.isSuccessful()) {
                    dialog.dismiss();
                    if (response.body().getStatus().equals("200")) {
                        Toast.makeText(MyAccountHome.this, "Your package has been upgraded!", Toast.LENGTH_SHORT).show();
    ...
    public void cardPartyPaymentDialog(final String priceValue, final int lastId) {
        ...
        new CountDownTimer(120000, 1000) {
            ...
            public void onFinish() {
                startActivity(new Intent(MyAccountHome.this, MainActivity.class)
...
*/
        ...
        monthET.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Constants.hideKeyboard(MyAccountHome.this);
                new RackMonthPicker(MyAccountHome.this)
        ...
        nextBT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cardET.getText().toString().isEmpty()) {
                    makeText(MyAccountHome.this, getString(R.string.please_enter_card), Toast.LENGTH_SHORT).show();
                    ...
                    makeText(MyAccountHome.this, getString(R.string.please_enter_cvv), Toast.LENGTH_SHORT).show();
            ...
            public void onResponse(Call<List<GetCardModel>> call, Response<List<GetCardModel>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.body().size() > 0) {
                        ...
                        listCards.add(model);
                        mainCardRV.setLayoutManager(new LinearLayoutManager(MyAccountHome.this));
                        adapter = new ShowCardAdapter(MyAccountHome.this, listCards);
                        ...
                        adapter = new ShowCardAdapter(MyAccountHome.this, listCards);
                        mainCardRV.setAdapter(adapter);
                        Toast.makeText(MyAccountHome.this, "No cards to show", Toast.LENGTH_SHORT).show();
                    }
