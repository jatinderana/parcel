...
class HwAdapter extends BaseAdapter {
    ...
    public ArrayList<HomeCollection> date_collection_arr = new ArrayList<>();
    ...
    public void getPositionList(String date, final Activity act) {
        ...
        if (jbarrays.length() != 0) {
            ...
            TextView tv_date = dialogs.findViewById(R.id.tv_date);
            LinearLayout mainLL = dialogs.findViewById(R.id.mainLL);
